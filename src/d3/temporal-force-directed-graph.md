...
This page visualizes a temporal network which [changes over time](https://observablehq.com/@d3/modifying-a-force-directed-graph). Each node and link has a _start_ and _end_ specifying its existence. The data here represents face-to-face interactions at a two-day conference. Data: [SocioPatterns](https://observablehq.com/@d3/sfhh-conference-data)
