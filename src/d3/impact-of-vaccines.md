---
source: https://observablehq.com/@d3/the-impact-of-vaccines
index: true
---
...
const data = await (async function() {
  ...
  const data = await FileAttachment("../data/vaccines.json").json();
  const values = [];
...
For a recreation of this chart with [Observable Plot](https://observablehq.com/plot/)’s concise API, see [this page](../plot/impact-of-vaccines).
