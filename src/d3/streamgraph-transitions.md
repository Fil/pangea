---
source: https://observablehq.com/@d3/streamgraph-transitions
index: true
---

# Streamgraph transitions

See also a more practical [static streamgraph using Observable Plot](/plot/wiggle-streamgraph).

```js
const offset = view(Inputs.select(new Map([
