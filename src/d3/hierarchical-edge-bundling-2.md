...
This chart shows relationships among classes in a software hierarchy. Each directed edge, going from ${html`<b style="color: ${color(0.1)};">source</b>`} to ${html`<b style="color: ${color(0.9)};">target</b>`}, corresponds to an import.
...
svg.append("g")
  ...
  .join("path")
    .style("mix-blend-mode", dark ? "lighter" : "darken")
