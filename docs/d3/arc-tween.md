---
source: https://observablehq.com/@d3/arc-tween
block: https://blocks.roadtolarissa.com/mbostock/5100636
author: Mike Bostock
index: true
---
...
A commented example of tweening arcs; see [Pie Chart Update, II](https://blocks.roadtolarissa.com/mbostock/1346410) and [Arc Tween (Clock)](https://blocks.roadtolarissa.com/mbostock/1098617) for older examples. (There’s also [The Amazing Pie](https://blocks.roadtolarissa.com/mbostock/4341574) and [Donut Transitions](https://blocks.roadtolarissa.com/mbostock/4341417) if you want to get fancy.) See the API reference for [*transition*.attrTween](https://d3js.org/d3-transition#transition_attrTween) and my tutorial [Working with Transitions](https://bost.ocks.org/mike/transition/) for more.
